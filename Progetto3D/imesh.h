...
namespace gobj
{
	namespace mesh
	{
		...
		public:
			...
			virtual void set_ref_sys(vec3 front, vec3 up) = 0;
			...
			virtual void move(Directions dir, float speed) = 0;
			virtual void turn(EulerAngle dir) = 0;
			virtual void turn(EulerAngle dir, float angle) = 0;
