...
namespace color {
	...
	const glm::vec4 dark_green = glm::vec4(17 / 255.0, 74 / 255.0, 39 / 255.0, 1.0);
	...
	const glm::vec4 crimson = glm::vec4(146 / 255.0, 44 / 255.0, 65 / 255.0, 1.0);
	const glm::vec4 dark_crimson = glm::vec4(94 / 255.0, 28 / 255.0, 42 / 255.0, 1.0);
	const glm::vec4 orange = glm::vec4(220 / 255.0, 152 / 255.0, 81 / 255.0, 1.0);
	const glm::vec4 sand = glm::vec4(243 / 255.0, 234 / 255.0, 191 / 255.0, 1.0);
	const glm::vec4 dark_blue_gray = glm::vec4(31 / 255.0, 38 / 255.0, 64 / 255.0, 1.0);
}
